    ...
    <div class="header">
        <div class="container d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0">Zalogowany: <strong><?php echo htmlspecialchars($current_user['username']); ?></strong> • Źródło: <strong><?php echo htmlspecialchars($current_source); ?></strong></p>
            </div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <?php if ($current_user['role'] === 'admin'): ?>
                            ...
                            <li><a class="dropdown-item" href="admin_users.php"><i class="fas fa-users"></i> Zarządzaj użytkownikami</a></li>
                        <?php endif; ?>
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger" href="logout.php"><i class="fas fa-sign-out-alt"></i> Wyloguj się</a></li>
                    </ul>
                </div>
            </div>
        </div>
